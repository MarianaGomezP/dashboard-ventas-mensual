...
<header class="hdr">
  ...
  <div class="ctrl-group">
    ...
    <div class="vtab-row">
      ...
      <button class="vtab" id="btn-ceco" onclick="setView('ceco',this)">Por Centro Comercial</button>
    </div>
  </div>
  ...
  <div class="ctrl-group">
    ...
    <div class="vtab-row">
      ...
      <button class="vtab" id="btn-comp" onclick="setModo(true)">Comparar meses</button>
    </div>
  </div>
...
<main>
  ...
  <div id="view-gerencia">
    ...
    <div class="g2" style="margin-top:14px">
      ...
      <div class="card">
        <div class="card-title">Ranking de Centros</div>
    ...
    <div class="g3">
      ...
      <div class="card">
        <div class="card-title">Cumplimiento Presupuesto por Centro</div>
        <div class="ch-wrap" style="height:210px"><canvas id="ch-ppto-g"></canvas></div>
      </div>
      <div class="card">
        <div class="card-title">Ingresos por Centro</div>
    ...
    <div class="g46">
      <div>
        <div class="card" style="margin-bottom:12px">
          <div class="card-title">Top 10 Crecimiento vs 2025</div>
          <div id="top-crec" class="blist"></div>
        </div>
        <div class="card">
          <div class="card-title">Top 10 Caída vs 2025</div>
          <div id="top-caida" class="blist"></div>
        </div>
      </div>
      <div class="card">
        <div class="card-title">Comparativo entre Centros — Evolución</div>
  ...
  <div id="view-ceco" hidden>
    ...
    <div class="section-title" id="ceco-titulo">Centro Comercial</div>
    ...
    <div class="g2">
      <div class="card">
        <div class="card-title">Top 20 Marcas por Venta 2026</div>
        <div id="top-marcas-c" class="blist"></div>
      </div>
      <div class="card">
        <div class="card-title">Top 10 Marcas en Riesgo (Caída vs 2025)</div>
        ...
        <table class="mtbl" id="mtbl">
          <thead>
            <tr>
              ...
              <th style="text-align:center">MM/MT</th>
...
function filtered(extra) {
  return D.por_marca.filter(r => inMes(r) && inMmMt(r) && inCat(r) && inFoco(r) && (!extra || extra(r)));
}
    ...
    options:{responsive:true, maintainAspectRatio:false,
      plugins:{legend:{labels:{font:{family:'Sora',size:11},boxWidth:14}},
        tooltip:{mode:'index', intersect:false, callbacks:{
          ...
          footer: items => items.length ? 'Marcas reportando: ' + marcasXMes[items[0].dataIndex] : ''
        }}},
...
function renderRankingG() {
  ...
  el.innerHTML = `<table class="rtbl"><thead><tr>
    <th>Centro</th><th class="num">Venta 2026</th><th class="num">Venta/m²</th><th class="num">vs 2025</th><th class="num">vs PPT Ventas</th><th class="num">Cumpl. Ing. Variable</th><th class="num">TE</th>
  </tr></thead><tbody>` +
  data.map(d => `<tr>
...
function renderMarcaTable() {
  ...
  tbody.innerHTML = filtered2.map(r => `<tr>
    ...
    <td style="text-align:center"><span class="chip chip-n" style="font-size:10px">${r.mm_mt||''}</span></td>
